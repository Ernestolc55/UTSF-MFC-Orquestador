...
# Fixes: cryptography, Cohere FASE 0 corregido, fallback Qwen,
#        circuit breaker Groq, git pull en workflow
# ═══════════════════════════════════════════════════════════════
...
# ─── COHERE SEMÁNTICO (SIN CAMBIOS – /v1/embed sigue activo según consenso) ───
...
def main():
    ...
    # Cohere (corregido: usa /v1/embed, no /v1/generate)
    if COHERE_API_KEY:
